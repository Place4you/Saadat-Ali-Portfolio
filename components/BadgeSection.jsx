  ...
  return (
    <div className="container mx-auto px-4 py-16 bg-black">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {/* LinkedIn Badge */}
        <div className="relative bg-gradient-to-r from-[#0072b1] to-[#005582] text-white p-8 rounded-xl shadow-2xl backdrop-blur-md backdrop-opacity-40 cursor-pointer">
          <div className="transform transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_15px_5px_rgba(0,114,177,0.4)]">
            <img
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm opacity-80">
                Full Stack Developer | Laravel Developer | SEO
              </p>
        ...
        {/* GitHub Badge */}
        <div className="relative bg-gradient-to-r from-gray-800 to-gray-900 text-white p-8 rounded-xl shadow-2xl backdrop-blur-md backdrop-opacity-40 cursor-pointer">
          <div className="transform transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_15px_5px_rgba(50,50,50,0.4)]">
            <img
        ...
        {/* Upwork Badge */}
        <div className="relative bg-gradient-to-r from-green-600 to-green-700 text-white p-8 rounded-xl shadow-2xl backdrop-blur-md backdrop-opacity-40 cursor-pointer">
          <div className="transform transition-transform duration-300 hover:scale-105 hover:shadow-[0_0_15px_5px_rgba(34,197,94,0.4)]">
            <img
